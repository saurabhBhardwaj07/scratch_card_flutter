...
class WaveSpinnerLoader extends StatefulWidget {
  const WaveSpinnerLoader({
    Key? key,
    required this.color,
  ...
  @override
  State<WaveSpinnerLoader> createState() => _WaveSpinnerLoaderState();
}

class _WaveSpinnerLoaderState extends State<WaveSpinnerLoader>
